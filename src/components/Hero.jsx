    ...
    <div className='flex flex-col space-y-6 lg:space-y-7'>
      <div className="flex flex-row items-center">
                ...
                smooth={true} 
                  spy={true} 
                  duration={500}
                ><button className='px-6 py-3 lg:px-7 lg:py-3.5 rounded-lg bg-neutral-900 hover:bg-black text-white dark:bg-amber-500 dark:hover:bg-amber-600 dark:text-neutral-900 font-medium shadow-lg hover:shadow-neutral-900/50 dark:hover:shadow-amber-500/20 flex items-center transiiton group cursor-pointer'>
                ...
                <a href="https://drive.google.com/file/d/1QAGl-XrNEmokdlboh3K_WD5pfFm3Ce58/view?usp=drivesdk" download="Osinachi's_CV" target='_blank'><button className='px-6 py-3 lg:px-7 lg:py-3.5 rounded-lg bg-neutral-100 hover:bg-neutral-200 dark:bg-neutral-800 dark:text-white  font-medium shadow-lg hover:shadow-neutral-900/20 dark:hover:bg-neutral-700 text-neutral-800 flex items-center transiiton group border border-neutral-300 dark:border-neutral-700 cursor-pointer'>
