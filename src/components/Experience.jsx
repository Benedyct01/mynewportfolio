    ...
    >
      ...
      <div className="flex  flex-col sm:-mx-4  sm:flex-row">
        ...
        />
          ...
          <h1 className=" mt-4 sm:mx-4 sm:mt-0text-xl dark:text-white font-semibold font-poppins capitalize md:text-2xl dark:group-hover:bg-gradient-to-r dark:group-hover:from-[#fbbf24] dark:group-hover:to-[#f59e0b] dark:group-hover:text-transparent dark:group-hover:bg-clip-text dark:group-hover:webkit group-hover:bg-gradient-to-r group-hover:from-[#42164d] group-hover:to-[#2c2923] group-hover:text-transparent group-hover:bg-clip-text group-hover:webkit">
            {experience.company}
          </h1>
                </div>

            <h3 className="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-white">{experience.position}</h3>
          <p className="text-sm font-poppins font-normal dark:text-gray-500 mt-3 group-hover:text-gray-400">
            {experience.duration}
          </p>

      <p className="mt-8 text-gray-500 dark:text-gray-300 group-hover:text-white group-hover:font-light font-poppins">
      {experience.p1} <br></br>
      {experience.p2} <br></br>
      {experience.p3}
      </p>
